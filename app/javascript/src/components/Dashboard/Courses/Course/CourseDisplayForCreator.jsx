...
import { Button, Badge, Label, Alert, Toastr, Dropdown } from "neetoui";
      ...
      <PageHeading
        ...
        rightButton={() => (
          <>
            ...
            >
              {course.published ? "Published course" : "Unpublished course"}
            </Badge>
            ...
            >
              ...
              <li
                onClick={() => {
                  history.push(`/courses/${course.id}/preview`);
                }}
              >
                Preview
              </li>
...
export default CourseDisplayForCreator;
