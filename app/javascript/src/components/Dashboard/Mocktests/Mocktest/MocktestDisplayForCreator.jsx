...
import { Button, Badge, Label, Toastr, Dropdown, Alert } from "neetoui";
import {
  deleteMocktest,
  publishMocktest,
  unpublishMocktest,
...
function MocktestDisplayForCreator({ mocktest, fetchSingleMocktest, history }) {
...
export default MocktestDisplayForCreator;
